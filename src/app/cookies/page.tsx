export default function CookiesPage() {
  return (
    <main className="mx-auto max-w-4xl px-4 py-10 prose prose-gray max-w-none bg-white">
      <h1>Cookie Policy - Luca Calcio AI</h1>
      ...
      <p>
        <strong>Email:</strong> chris@starsite.digital<br/>
        <strong>Company:</strong> Edge Ahead Media Limited<br/>
        <strong>Website:</strong> Luca Calcio AI
      </p>
